...
def train_transformer_model(model_instance, X_train, X_val, X_test, y_train, y_val, y_test, num_epochs, dataset_name):
    ...
    model_path = f'/your_path/EnDeep4mC/pretrained_models/indiv_cross_species/transformer_{dataset_name}.h5'
    callbacks = [
...
if __name__ == "__main__":
    ...
    print("\nFinal Test Result:")
    print(summary_df)
    summary_df.to_csv('/your_path/EnDeep4mC/pretrained_models/indiv/transformer_auto_summary.csv', index=False)