...
from feature_engineering.feature_selection import load_top_features, get_feature_methods, load_best_n, load_best_n
...
def build_transformer_model(input_dim, num_heads=8, ff_dim=512, num_layers=2, dropout=0.1):
    """Build an instance of the Transformer model"""
...
def save_combined_results(summary_data):
    ...
    print(summary_df)
    summary_path = '/your_path/EnDeep4mC/pretrained_models/5cv/transformer_5cv_summary.csv'
