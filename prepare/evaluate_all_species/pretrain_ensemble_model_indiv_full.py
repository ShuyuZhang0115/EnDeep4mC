...
class EnhancedEnsembleIndiv:
    ...
    def _load_full_dataset(self, model_name):
        ...
        X_full, y_full, _ = ml_code(full_df, "training")
    ...
    def _load_pretrained_model(self, model_name):
        model_path = f'/your_path/EnDeep4mC/pretrained_models/indiv_14_feature/{model_name.lower()}_{self.dataset_name}.h5'
    ...
    def train_and_evaluate(self):
        ...
        # Save model
        model_path = f'/your_path/EnDeep4mC/pretrained_models/indiv_14_feature/ensemble_indiv_{self.dataset_name}.pkl'
        ...
        roc_df.to_csv(
            os.path.join(project_dir, 'pretrained_models/indiv_14_roc', f'Ensemble_roc_{self.dataset_name}.csv'),
            index=False,
            float_format='%.6f'
        )
        ...
        plt.savefig(os.path.join(project_dir, 'pretrained_models/indiv_14_roc', f'Ensemble_roc_{self.dataset_name}.png'))
        plt.close()
...
if __name__ == "__main__":
    ...
    save_path = '/your_path/EnDeep4mC/pretrained_models/indiv_14_feature/ensemble_indiv_results.csv'
