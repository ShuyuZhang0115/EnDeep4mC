...
model_config = [
    ("CNN", [
        "/your_path/EnDeep4mC/evaluations/acc_matrix/CNN_ACC_Matrix.csv",
        "/your_path/EnDeep4mC/evaluations/acc_matrix_extra/CNN_ACC_Matrix.csv"
    ]),
    ("BLSTM", [
        "/your_path/EnDeep4mC/evaluations/acc_matrix/BLSTM_ACC_Matrix.csv",
        "/your_path/EnDeep4mC/evaluations/acc_matrix_extra/BLSTM_ACC_Matrix.csv"
    ]),
    ("Transformer", [
        "/your_path/EnDeep4mC/evaluations/acc_matrix/Transformer_ACC_Matrix.csv",
        "/your_path/EnDeep4mC/evaluations/acc_matrix_extra/Transformer_ACC_Matrix.csv"
    ])
]
...
if __name__ == "__main__":
    output_dir = "/your_path/EnDeep4mC/evaluations/acc_heatmap"
